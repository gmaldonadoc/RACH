...
ClassifierParameters::ClassifierParameters(int sourceID, int destinationID, int sourcePort, int destinationPort, TransportProtocol::TransportProtocolType protocol) {
  m_sourceID = sourceID;
