...
{
private:
  typedef std::vector<UserEquipment *> UserEquipmentsDoingRandomAccess;
  UserEquipmentsDoingRandomAccess *m_userEquipmentsDoingRandomAccess;
  ...
  // void teste()
  // {
  //   (*m_eNodeBContainer)[0]->GetProtocolStack()->GetM_MAC();
  //   // (i->GetProtocolStack()->GetM_MAC());
  // }
...
public:
  ...
  void AddUserEquipmentDoingRandomAccess(UserEquipment *UE);
  void RemoveUserEquipmentDoingRandomAccess(UserEquipment *UE);
  UserEquipmentsDoingRandomAccess *GetUserEquipmentsDoingRandomAccess(void);
  ...
  std::vector<Gateway *> *GetMGatewayContainer(void);
};
