...
public:
	...
	double ComputeFDSchedulingMetric(FlowToSchedule *, int);
	double ComputeTDSchedulingMetric(FlowToSchedule *);

	void TDScheduling(FlowsToSchedule *);
...
private:
	DownlinkPacketScheduler *objScheduler;
	int m_nAvailableRBs;
};
