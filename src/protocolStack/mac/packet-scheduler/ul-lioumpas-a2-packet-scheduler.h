...
#ifndef UL_LIOUMPAS_A2_PACKET_SCHEDULER_H
#define	UL_LIOUMPAS_A2_PACKET_SCHEDULER_H

#include "uplink-packet-scheduler.h"

class LioumpasA2UplinkPacketScheduler : public UplinkPacketScheduler {
public:
  LioumpasA2UplinkPacketScheduler();
  LioumpasA2UplinkPacketScheduler(UplinkPacketScheduler *sch);
  virtual ~LioumpasA2UplinkPacketScheduler();
