...
void
CartesianCoordinates::SetCoordinatesFromPolar(CartesianCoordinates *center, double radius, double angle) {
...
CartesianCoordinates::GetDistance(CartesianCoordinates *remoteObject) {
   ...
   */
  return sqrt(pow((GetCoordinateX() - remoteObject->GetCoordinateX()), 2) + pow((GetCoordinateY() - remoteObject->GetCoordinateY()), 2));
