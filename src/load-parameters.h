...
/* path */
static std::string path ("/home/maumau/Downloads/LTE-Sim_RA-Article_M2M_beta/LTE-Sim_RA-Article_M2M/");

/* Version */
static int _VERSION_ = 22;
/*
...
static bool RA_ENERGY_TRACE = true;
static bool ONLY_RANDOM_ACCESS = true;
static bool USE_PDCCH_MANAGER = true;
static bool USE_RANDOM_ACCESS = true;
static bool USE_POWER_CONTROL_SRS = true;
